...
class Reworker:
    ...
    def rework(self):
        df = self.df
        df = df.drop(['ID ','name ','category ','country ','state ','usd pledged ','Unnamed: 13','Unnamed: 14', 'Unnamed: 15','Unnamed: 16'], axis=1)
        ...
        df_reworked= df[['goal ','pledged ','backers ','currency ','main_category ']]
